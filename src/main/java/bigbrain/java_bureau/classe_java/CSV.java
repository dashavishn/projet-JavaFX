...
public class CSV {
    ...
    public  void LireElement () {
        String file = "src/main/java/bigbrain.java_bureau/elements.csv";
    ...
    public void LireChaine() {
        ...
        try {
            ...
            while ((line = reader.readLine()) != null) {
                ...
                ChaineProduction chaine = new ChaineProduction(row[0],row[1],elemEntree,elemSortie;
                Chaines.add(chaine);
    ...
    public  void LireHistorique() {
        ...
        try {
            ...
            while ((line = reader.readLine()) != null) {
                ...
                double r4 = Double.parseDouble(row[4]);
                double r5 = Double.parseDouble(row[5]);
                ModificationStockElement ch = new ModificationStockElement(row[0],row[1], r2, row[3], r4, r5,row[6]);
